...
dfIncomeInq['Italy', 2015] = dfIncomeInq['Italy', 2014]
dfIncomeInq['Italy', 2016] = dfIncomeInq['Italy', 2014]
dfIncomeInq['Italy', 2017] = dfIncomeInq['Italy', 2014]
dfIncomeInq['Italy', 2018] = dfIncomeInq['Italy', 2014]
dfIncomeInq['Italy', 2019] = dfIncomeInq['Italy', 2014]
dfIncomeInq['Canada', 2019] = dfIncomeInq['Canada', 2018]
dfIncomeInq['France', 2019] = dfIncomeInq['France', 2018]
dfIncomeInq['Germany', 2018] = dfIncomeInq['Germany', 2017]
dfIncomeInq['Germany', 2019] = dfIncomeInq['Germany', 2017]
dfIncomeInq['United Kingdom', 2018] = dfIncomeInq['United Kingdom', 2017]
dfIncomeInq['United Kingdom', 2019] = dfIncomeInq['United Kingdom', 2017]
''' ^^^^^^^ HAVE TO DELETE THIS LATER ^^^^^^^ '''
...
dfMentalHealth = dfCut['sum']
dfMentalHealth = dfMentalHealth.rename('mental_health')
...
current.to_csv("CurrentRaw.csv", header=True)
